...
namespace TRSS.Input
{
    ...
    /// </summary>
    public class LSButtonInput : ControllerInput
    {

        #region Trigger Keys.

        const string LS = "Left Stick Button";
        ...
        {
            this.Scheme.AddTrigger(LS, Controls.LS, ControlResponse.HELD);
        }
        ...
        {
            Trigger button = this.Scheme.GetTrigger(LS);
            float value = 0.0f;
            ...
            if (value != 0.0f)
            {
                this.AddMessage("The Left Stick button is being held down.");
            }
        }
